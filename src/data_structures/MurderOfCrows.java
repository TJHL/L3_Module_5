	...
	private void findTheDiamond() {
		...
		for (int i = 0; i < theMurder.size(); i++) {
			...
			if (theMurder.get(i).getStomachContents().contains("diamond")) {
				System.out.println(
						theMurder.get(i).getName() + " was the one that ate your intrisnically worthless diamond!!!!!");
				System.out.println((i + 1)
						+ " crows had to die to satisify your capitalistic reign of anti-vegan terror!!!!!!!!!!");
			}
